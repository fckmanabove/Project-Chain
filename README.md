...
- **Механика:** Идентификация данных производится на основе **алгоритма имен «Умных таблиц»** (Excel Tables). Система ищет таблицы с именами, соответствующими заданным шаблонам (например, `Tbl_Tasks_*`, `Tbl_Diary_*`), что обеспечивает стабильность импорта при перемещении таблиц между листами.
